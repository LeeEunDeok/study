...
<%
	/* 이전에 작성했던 게시물을 수정하는 것이므로 시작시 해당 게시물 정보를 읽어옵니다. */
	int no = 1;
...
/* 수정시 게시물 번호는 읽기 전용으로 사용자에 보여줍니다.*/
#boardNo1 {
	display: none;
	visibility: hidden;
}
	...
	<div class="container mt-3">
		...
		<form action="boUpdateTo.jsp">
			...
			<div class="input-group mb-3">
				...
				<input type="text" class="form-control" id="fakeid" value="hong" name="fakeid" value="${bean.id }"  disabled>
